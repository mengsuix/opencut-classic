				...
				>
					<TabsList>
						<TabsTrigger value="project-info">
							{t("assets.settingsProjectInfo")}
						</TabsTrigger>
						<TabsTrigger value="background">
							{t("assets.settingsBackground")}
						</TabsTrigger>
					</TabsList>
				</Tabs>
			}
					...
					<Select
							...
							>
								<SelectTrigger className="bg-transparent border-none p-1 h-auto">
									<SelectValue placeholder={t("assets.settingsSelectFrameRate")} />
								</SelectTrigger>
								<SelectContent>
									...
									uiOptions={
										<div className=" flex items-center gap-2 text-foreground">
											<NumberField
												...
												className="w-full"
												aria-label={t("assets.canvasWidth")}
											...
											<NumberField
												...
												className="w-full"
												aria-label={t("assets.canvasHeight")}
